package com.dassmeta.weixin.web.admin.filter;
...
import com.dassmeta.weixin.web.home.util.CookieUtils;
...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		String adminLoginCookieName = request.getServletContext().getInitParameter("loginCookieName");

		String loginCookie = CookieUtils.get(servletRequest, adminLoginCookieName);
